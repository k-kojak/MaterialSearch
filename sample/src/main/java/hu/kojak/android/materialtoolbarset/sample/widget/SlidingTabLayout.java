...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    // TODO: this should be read from the layout xml
    ...
    private boolean mSelectableItems = true;
     ...
     */
    protected TextView createDefaultTextView(Context context) {
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            TextView tabView = createDefaultTextView(getContext());
...
//            tabImageView.setImageDrawable(ContextCompat.getDrawable(getContext(), adapter.getDrawableId(i)));
//            if (i == mViewPager.getCurrentItem()) {
